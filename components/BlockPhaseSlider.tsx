...
export const SLIDER_PHASE_CONFIG: Record<SliderPhase, {
  ...
  power: {
    ...
    track: 'from-fuchsia-600 to-pink-500',
    glow: 'rgba(192, 38, 211, 0.2)',
    labelColor: 'text-fuchsia-300',
    chipBg: 'bg-fuchsia-500/15',
    chipBorder: 'border-fuchsia-500',
    weekLabel: 'text-fuchsia-400/90',
  },
  peaking: {
    label: 'Peaking',
    trainingPhase: TrainingPhase.PEAKING,
    track: 'from-rose-600 to-red-500',
  ...
  deload: {
    ...
    track: 'from-slate-500 to-slate-400',
    glow: 'rgba(100, 116, 139, 0.15)',
    labelColor: 'text-slate-300',
    chipBg: 'bg-slate-500/15',
    chipBorder: 'border-slate-500',
    weekLabel: 'text-slate-400/90',
  },
};
